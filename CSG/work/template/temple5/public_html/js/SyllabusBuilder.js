...
function buildInstructor(){
    ...
    loadInstructorData(dataFile,newInstru);


}

function loadInstructorData(jsonFile,callback){
...
function newInstru(json){
    if(json.course_instructor_name!=undefined){
      $("#instructorName").text(json.course_instructor_name);
        
    }
    if (json.course_instructor_home!=undefined){
      $("#instructorHome").text(json.course_instructor_home);
      $("#instructorHome").attr("href",json.course_instructor_home);
    }
...
//officeHoursGrid part
function buildOfficeHoursGrid() {
    var dataFile = "./data/SiteSaveTestExport.json";
    loadOfficeHourData(dataFile, loadOfficeHours);
}

function loadOfficeHourData(jsonFile, callback) {
    $.getJSON(jsonFile, function(json) {
        callback(json);
    });
}
...
function buildRecitations() {   
    var dataFile = "./data/SiteSaveTestExport.json";
    loadRecitationData(dataFile, addRecitations);
}


function loadRecitationData(jsonFile, callback) {
    $.getJSON(jsonFile, function(json) {
        callback(json);
    });
}
