...
public abstract class AppTemplate extends Application {
	...
	try {
       ...
       ChoiceDialog<String> dialog = new ChoiceDialog<>("English", choices);
        dialog.setTitle("Choice Language");
...
// The Java 8 way to get the response value (with lambda expression).
           ...
           // System.out.println("99098898");
            boolean success; 
            if(result.get()=="中文"){
                success = loadProperties(CHINESE_APP_PROPERTIES_FILE_NAME);
            }else{
	       success = loadProperties(ENGLISH_APP_PROPERTIES_FILE_NAME);
            }
