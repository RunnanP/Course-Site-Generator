...
public class AppStartupConstants
{
    ...
    public static final String ENGLISH_APP_PROPERTIES_FILE_NAME = "english_app_properties.xml";
    public static final String CHINESE_APP_PROPERTIES_FILE_NAME = "chinese_app_properties.xml";
    ...
    public static String ENGLISH_PROPERTIES_FILE_ERROR_MESSAGE = "Error Loading " + ENGLISH_APP_PROPERTIES_FILE_NAME;
    public static String CHINESE_PROPERTIES_FILE_ERROR_MESSAGE = "Error Loading " + CHINESE_APP_PROPERTIES_FILE_NAME;
